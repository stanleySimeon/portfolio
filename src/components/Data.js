const Data = [
  {
    ...
    title: 'Bookstore CMS',
    description: 'A content management system for a bookstore, built with React and Redux.The app allows users to add and remove books from the store, and filter books by category.',
  ...
  },
  {
    ...
    title: 'Leaderboard',
    description: 'A leaderboard app built with React and Redux. The app allows users to add scores to a leaderboard and sort them by highest score.',
    technologies: ['React', 'Redux', 'JavaScript ES6', 'CSS', 'HTML'],
  ...
  {
    id: 5,
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAPqdcgpBx7AxjZhUbqwT7WV6_g-AM5g2z9w&usqp=CAU',
    title: 'Restaurant Page',
    description: 'A restaurant page built with JavaScript ES6, Webpack, and Bootstrap. The app allows users to view the menu, contact information, and location of the restaurant.',
    technologies: ['JavaScript ES6', 'Webpack', 'Bootstrap', 'CSS', 'HTML'],
    liveLink: 'https://restaurant-page-2021.herokuapp.com/',
    sourceLink: '',
  },
  {
    id: 6,
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsmA_PNznQW8wSrgIaJYv8rrBH-OP9-G9hhw&usqp=CAU',
    title: 'To Do List',
    description: 'A to do list app built with JavaScript ES6, Webpack, and Bootstrap. The app allows users to add and remove tasks from a list.',
    technologies: ['JavaScript ES6', 'Webpack', 'Bootstrap', 'CSS', 'HTML'],
    liveLink: 'https://to-do-list-2021.herokuapp.com/',
    sourceLink: '',
  },
];
